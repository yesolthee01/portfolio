  ...
  },
  {
    ...
    caseStudy: {
      kr: {
        ...
        resultHeadline: '역할별로 가장 중요한 정보를\n한 화면에서 확인할 수 있도록 했습니다.',
        resultHighlights: [
          { role: '교사', info: '일정 · 출석 확인' },
          { role: '주방 담당자', info: '식사 인원 · 식이 요구사항 확인' },
          { role: '기숙사 담당자', info: '학생 출결 · 현황 확인' },
        ],
        resultVerification:
          '역할별 Dashboard 프로토타입을 교직원에게 공유해 실제 업무 흐름과 정보 구성의 적합성을 확인했습니다. 각 역할에 필요한 정보를 한 화면에서 빠르게 확인할 수 있다는 점에 긍정적인 피드백을 받았습니다.',
        resultInsight: '기능을 늘리기보다, 업무 맥락에 맞춰 정보의 우선순위를 재구성하는 것이 핵심이었습니다.',
